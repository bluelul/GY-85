...
int* GY_85::readFromAccelerometer()
{
    ...
    axis[0] =(int)(short) (((buff[1]) << 8) | buff[0]);
    axis[1] = (int)(short)(((buff[3]) << 8) | buff[2]);
    axis[2] = (int)(short)(((buff[5]) << 8) | buff[4]);
...
int* GY_85::readGyro()
{
    ...
    axis[0] = (int)(short)((buff[4] << 8) | buff[5]) - g_offx;
    axis[1] = (int)(short)((buff[2] << 8) | buff[3]) - g_offy;
    axis[2] = (int)(short)((buff[6] << 8) | buff[7]) - g_offz;
    axis[3] = (int)(short)((buff[0] << 8) | buff[1]);       // temperature
