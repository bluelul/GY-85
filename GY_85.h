...
public:
    ...
    inline int gyro_x( int* a ){ return *(   a ) / 14.375; }
    inline int gyro_y( int* a ){ return *( 1+a ) / 14.375; }
    inline int gyro_z( int* a ){ return *( 2+a ) / 14.375; }
    inline int temp  ( int* a ){ return  35+( *( 3+a )+13200 ) / 280; }
};
